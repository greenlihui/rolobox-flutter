...
//
//     final filteredContacts = filteredContactsFromJson(jsonString);

import 'dart:convert';

class FilteredContacts {
  List<Datum> data;
  ...
  factory FilteredContacts.fromRawJson(String str) => FilteredContacts.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory FilteredContacts.fromJson(Map<String, dynamic> json) => FilteredContacts(
