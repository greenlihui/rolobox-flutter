...
class ScannerUtils {
  ...
  static FirebaseVisionImage getFirebaseVisionImage(CameraImage image, int imageRotation) {
    return FirebaseVisionImage.fromBytes(_concatenatePlanes(image.planes), _buildMetaData(image, _rotationIntToImageRotation(imageRotation)));
  }
